...
func set_is_riding_boat(value: bool):
	...
	if is_riding_boat and current_boat:
		rpc("_reparent_with_shield", current_boat.get_path())
	else:
		rpc("_reparent_with_shield", get_tree().current_scene.get_path())
		
@rpc("any_peer", "call_local", "reliable")
func _reparent_with_shield(new_parent_path: NodePath) -> void:
